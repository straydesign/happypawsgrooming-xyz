...
export default function TiltCard({
  ...
  return (
    <motion.div
      ref={ref}
      className={cn(
        'relative overflow-hidden rounded-2xl border border-warm-border bg-warm-card p-6 shadow-sm transition-shadow hover:shadow-lg md:p-8',
        className
      )}
      style={{
        perspective: '800px',
    ...
    >
      ...
      <div className="pointer-events-none absolute top-0 right-0 left-0 h-px bg-gradient-to-r from-transparent via-warm-border to-transparent" />
