...
export default function MagneticButton({
  ...
  const variants = {
    ...
    secondary:
      'bg-primary-dark text-white hover:bg-primary-dark/90 shadow-lg shadow-primary-dark/25',
    ghost:
      'bg-transparent text-primary-dark border-2 border-primary-dark hover:bg-primary-dark hover:text-white',
  };
